...
public:
    ...
    SecurityInterface::TlsInfo getAesKey(SOCKET_TYPE socket) override;
    ...
    void dealTlsRequest(SOCKET_TYPE socket, std::function<void(bool, TlsInfo)> callback) override;
